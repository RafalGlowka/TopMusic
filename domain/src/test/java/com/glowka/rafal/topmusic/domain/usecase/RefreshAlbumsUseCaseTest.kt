...
class RefreshAlbumsUseCaseTest {
  ...
  lateinit var useCase: RefreshAlbumsUseCase

  @Before
  fun prepare() {
    MockKAnnotations.init(this)
    useCase = RefreshAlbumsUseCaseImpl(
  ...
  fun useCaseIsCallingRepositories() = runBlocking {
    ...
    every { musicRepository.refreshListFromNetwork() } returnsSuccess list
    ...
    verify { musicRepository.refreshListFromNetwork() }
  }
}